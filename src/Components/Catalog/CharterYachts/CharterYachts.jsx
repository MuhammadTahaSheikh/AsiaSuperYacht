...
import "./CharterYachts.css"; // Import your CSS file
...
const CharterYachts = ({ handleEnquireClick, mySectionRef }) => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get("/api/charter-yachts-products");
    ...
    <>
      ...
      <div className="about_back">
        <div className="list_building">
          <p className="catalog_nav_head pt-5 ">
            Charter Yacht for Sale Catlog
          </p>
          <div className="text-center pb-5">
            ...
            <span className="subHead_about">Charter Yachts</span>
          </div>
        </div>
      </div>
