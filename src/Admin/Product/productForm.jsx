                  ...
                  formDataProduct1?.imageUpload?.map((urls, ind) => {
                    return (
                      ...
                      >
                        {/* <img
                          src={
                            // Check if the URL starts with the base URL to prevent double appending
                            `${process.env.REACT_APP_BASE_URL}${
                              urls.startsWith(
                                "https://backend.asiasuperyachts.com"
                              ) ||
                              urls.startsWith(
                                "http://backend.asiasuperyachts.com"
                              )
                                ? urls.replace(
                                    /^https?:\/\/backend\.asiasuperyachts\.com\//,
                                    ""
                                ...
                                : urls
                            }` // If it's already a relative URL, just use it as is
                          }
                          alt="Uploaded Images"
                          height="150px"
                          width="150px"
                        ...
                        {/* <img
                          src={`${process.env.REACT_APP_BASE_URL}${urls.replace(
                            /^https?:\/\/backend\.asiasuperyachts\.com\//, // Ensure the slash after the domain is included in the match
                            "" // This removes the base URL part (i.e., backend.asiasuperyachts.com/)
                          )}`}
                          alt="Uploaded Images"
                          height="150px"
                          width="150px"
                        ...
                        {/* <img
                          src={`${process.env.REACT_APP_BASE_URL}${urls}`}
                          alt="Uploaded Images"
                          height="150px"
                          width="150px"
                        /> */}
